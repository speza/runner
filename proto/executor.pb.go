...
func (x *Request) GetArgs() map[string]string {
	if x != nil {
		return x.Args
	}
	return nil
...
var file_proto_executor_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x2e, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x2e, 0x41, 0x72, 0x67, 0x73,
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x24, 0x0a, 0x08, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65,
	0x12, 0x18, 0x0a, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x07, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x32, 0x33, 0x0a, 0x08, 0x45, 0x78,
	0x65, 0x63, 0x75, 0x74, 0x6f, 0x72, 0x12, 0x27, 0x0a, 0x02, 0x44, 0x6f, 0x12, 0x0e, 0x2e, 0x70,
...
var file_proto_executor_proto_goTypes = []interface{}{
	...
	nil,              // 2: proto.Request.ArgsEntry
}
var file_proto_executor_proto_depIdxs = []int32{
	2, // 0: proto.Request.args:type_name -> proto.Request.ArgsEntry
	0, // 1: proto.Executor.Do:input_type -> proto.Request
	1, // 2: proto.Executor.Do:output_type -> proto.Response
...
func (c *executorClient) Do(ctx context.Context, in *Request, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/proto.Executor/Do", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedExecutorServer) Do(context.Context, *Request) (*Response, error) {
...
func _Executor_Do_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Request)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ExecutorServer).Do(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Executor/Do",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExecutorServer).Do(ctx, req.(*Request))
	}
